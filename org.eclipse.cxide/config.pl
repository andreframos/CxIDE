...
:-dialog_setAction('Fórmula Resolvente','getNumField(''Fórmula Resolvente'',''a'',A),getNumField(''Fórmula Resolvente'',''b'',B),getNumField(''Fórmula Resolvente'',''c'',C),equation(A,B,C,R1,R2)').
%:-dialog_setAction('Fórmula Resolvente','writeln(''ok'')').
