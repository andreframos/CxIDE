...
public class MovingBoxContentProvider implements ITreeContentProvider, IDeltaListener {
	...
	*/
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		...
		if(oldInput != null) {
			removeListenerFrom((PredNode)oldInput);
		}
		if(newInput != null) {
			addListenerTo((PredNode)newInput);
		}
	}
	...
	protected void removeListenerFrom(PredNode box) {
		box.removeListener(this);
		for (Iterator iterator = box.getBoxes().iterator(); iterator.hasNext();) {
			PredNode aBox = (PredNode) iterator.next();
	...
	protected void addListenerTo(PredNode box) {
	...
	public Object[] getChildren(Object parentElement) {
		if(parentElement instanceof PredNode) {
			PredNode box = (PredNode)parentElement;
	...
	public void add(DeltaEvent event) {
		Object movingBox = ((Node)event.receiver()).getParent();
