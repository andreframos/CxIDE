...
/**
 * This class is used to add contribution to the CxExternalConsole
 * Namely a restart button on the toolbar of the console
 * @author andreramos
 *
 */
public class CxInternalButtonsContribution implements IConsolePageParticipant {
	 ...
	 private void createTerminateAllButton() {
	        ...
	        this.stop = new Action("Terminate", imageDescriptor) {
	            public void run() {
	            	...
	            	CxInternalConsole.test();
	            	Prolog.coroutiningInterrupt("cxThread");
	            	CxInternalConsole.runABit();
	            }
	        };
